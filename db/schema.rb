...
ActiveRecord::Schema[8.0].define(version: 2026_08_02_000001) do
  ...
  create_table "blizzard_schedule_configs", force: :cascade do |t|
  ...
  create_table "reply_drafter_configs", force: :cascade do |t|
    t.text "instructions"
  ...
  create_table "substack_quotations", force: :cascade do |t|
  ...
  create_table "substack_sync_configs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "publication_host"
    t.bigint "author_id"
    t.text "subtitle"
    t.jsonb "footer_json"
    t.jsonb "default_tags"
    t.boolean "quotation_rotation_enabled", default: false, null: false
    t.text "subtitle_default"
    t.integer "quotation_rotation_days", default: 7, null: false
    t.datetime "quotations_rotated_at"
    t.bigint "reviews_draft_id"
    t.boolean "session_healthy", default: true, null: false
