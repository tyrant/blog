...
class Comfy::Admin::SubstackSyncConfigsController < Comfy::Admin::Cms::BaseController
  ...
  def config_params
    params.require(:substack_sync_config).permit(:subtitle, :subtitle_default, :subtitle_variables_json, :footer_json_text, :quotation_rotation_enabled, :quotation_rotation_days, :reviews_draft_id)
  end
