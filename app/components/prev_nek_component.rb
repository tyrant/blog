class PrevNekComponent < ViewComponent::Base
  ...
  def css_classes_for_category_label(category)
    classes = %w(order-first sm:order-none text-center text-lg px-1 w-auto sm:w-20 mx-auto sm:-mx-10 md:w-24 md:-mx-12 -my-0 bg-white z-10 rounded font-bold sm:opacity-90)
