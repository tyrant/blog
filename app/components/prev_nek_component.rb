class PrevNekComponent < ViewComponent::Base
  ...
  def css_classes_for_category
    ...
    classes = %w(text-center text-lg px-4 sm:px-1 py-1 h-8 -my-4 sm:h-auto sm:my-auto w-auto sm:w-20 mx-auto sm:-mx-10 md:w-24 md:-mx-12 -my-0 z-10 font-bold leading-tight shadow-lg)
